/**
 * DemonHelmet - A free and open-source MMORPG server emulator
 * Copyright (C) 2023 Oliveira -[DEV PROGRAMING]
 *
...
int LuaScriptInterface::luaItemClassificationCreate(lua_State* L) {
...
int LuaScriptInterface::luaItemClassificationAddTier(lua_State* L) {
